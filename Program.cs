...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            config = JsonSerializer.Deserialize<VisibilityConfiguration>(
                jsonContent,
        ...
        var finalBaseUrl = baseUrl ?? config.BaseUrl;
        ...
        Console.WriteLine($"Base URL: {finalBaseUrl}\n");

        toolName ??= "visibility";

        using var apiClient = new ApiClient(finalBaseUrl);
        ITool tool;
